...
- 📖 [**Guide Utilisateur**](USER_GUIDE.md) : Apprendre à intégrer la bibliothèque et parser des fichiers.
- 🛠️ [**Guide Développeur**](DEVELOPER_GUIDE.md) : Comprendre l'architecture et contribuer au projet.
